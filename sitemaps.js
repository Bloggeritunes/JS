...
var pll='';if("category"in entry){for(var k=0;k<entry.category.length;k++){pll+='<a href="javascript:filterPosts(\''+entry.category[k].term+'\');" title="Etikete ait tüm yayınları seçmek için buraya tıklayın. \''+entry.category[k].term+'\'">'+entry.category[k].term+'</a>,  ';}
...
function displayToc(filter){var numDisplayed=0;var tocTable='';var tocHead1='Yayın Başlığı';var tocTool1='Başlığa göre sıralamak için tıklayın';var tocHead2='Yayın Tarihi';var tocTool2='Tarihe göre sıralamak için tıklayın';var tocHead3='Etiketler';var tocTool3='';if(sortBy=="titleasc"){tocTool1+=' (descending)';tocTool2+=' (newest first)';}
...
if(postFilter!=''){tocTool3='Tüm yayınları göstermek için tıkla';}
...
tocTable+='</table>';if(numDisplayed==postTitle.length){var tocNote='<span class="ux-note">SİTEMİZDE '+postTitle.length+' YAYIN VAR<br/></span>';}
